...
public class ConstructionMaterialCalculatorTest {
    ...
    public void shouldSetProfileCorrectly() {
        when(materialService.createConstructionMaterial(anyString(), anyLong())).thenAnswer(invocation -> {
        ...
        verify(materialService).createConstructionMaterial(eq("Aluminium profile 40x40"), eq(21L));
    ...
    public void shouldSetProfileJoinerCorrectly(){
        when(materialService.createConstructionMaterial(anyString(), anyLong())).thenReturn(new InstallationMaterial());

        constructionMaterialCalculator.setProfileJoiner(12000);

        verify(materialService).createConstructionMaterial(eq("Profile joiner"), eq(2L));
    }
    @Test
    ...
    public void shouldSetHexagonScrewCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Hexagon screw M10x250"), anyLong());
    }
    @Test
    ...
    public void shouldSetHexagonNutCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Hexagon nut M10"), anyLong());
    }
    @Test
    ...
    public void shouldSetVarioHookCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Vario hook"), eq(10L));
    }
    @Test
    ...
    public void shouldSetDoubleHeadedScrewCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Double threaded screw L=250mm"), eq(10L));
    }
    @Test
    ...
    public void shouldSetAdapterObliqueCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Adapter"), eq(10L));
    }
    @Test
    ...
    public void shouldSetScrewsForVarioHookCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Screws for vario hook"), eq(40L));
    }
    @Test
    ...
    public void shouldSetSTrapezeCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Trapeze"), eq(22L));
    }
    @Test
    ...
    public void shouldSetScrewsForTrapezeCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Trapeze screws"), eq(60L));
    }
    @Test
    ...
    public void shouldSetAngleBarCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Aluminium angle bar 40x3"), eq(39L));
    }
    @Test
    ...
    public void shouldSetThreadedRodCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Threaded rod M10"), eq(22L));
    }
    @Test
    ...
    public void shouldSetEpdmCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("EPDM M10"), eq(10L));
    }
    @Test
    ...
    public void shouldSetChemicalAnchorCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Chemical anchor"), eq(2L));
    }
    @Test
    ...
    public void shouldSetSleeveCorrectly(){
        ...
        verify(materialService).createConstructionMaterial(eq("Sleeve for threaded rod"), eq(10L));
    }
    @Test
