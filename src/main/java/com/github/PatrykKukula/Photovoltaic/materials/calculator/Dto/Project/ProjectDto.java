...
public class ProjectDto {
    ...
    private String city;
    @NotEmpty(message = "Module power cannot be empty")
    ...
    @NotEmpty(message = "Module length cannot be empty")
